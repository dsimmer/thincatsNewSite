...
jQuery(".datepicker").datepicker({dateFormat: 'dd-mm-yy'});
		...
		function loginAlert(){
					jAlert('You need to be logged in to view the markletplace.<br><br><a href="/login">Login</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://thincats.azurewebsites.net/account/lender/register">Register</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="/about">Find out more</a><br>');
					return false;
		}
...
<!--                            <span><strong>Registered Lenders:</strong> --><!--</span><br />-->
			...
			<div class="buttons clearfix">
                                                       <a href="https://thincats.azurewebsites.net/account/lender/register"  class="btn-reg"><span></span>register</a>
				<a href="https://thincats.azurewebsites.net/account/login" class="btn-log"><span></span>Log in</a>
...
<ul class="sub-menu">
	...
	<li id="menu-item-4088" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-4088"><a href="https://thincats.azurewebsites.net/account/lender/register/">Member Registration</a></li>
...
<ul class="sub-menu">
	...
	<li id="menu-item-1503" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1503"><a href="https://thincats.azurewebsites.net/account/borrower/register">Apply for a loan</a></li>
</ul>
</li>
...
<script>
	jQuery('input[name=jobman-field-48]').attr('multiple', 'multiple').attr('name', 'jobman-field-48[]');
        ...
        <a href="https://thincats.azurewebsites.net/account/lender/register/" class="i-btn i-btn-lg i-btn-white">sign up now</a>
    </section>
...
<a href="https://thincats.azurewebsites.net/account/lender/register/">Register</a>
    </div>
    <div class="col-lg-2">
      <h3>Borrowing</h3>
      <a href="/borrowing/about-borrowing/">About Borrowing</a>
<a href="/statistics/">Key Statistics</a>
<a href="https://thincats.azurewebsites.net/account/borrower/register">Apply for a loan</a>
    </div>
    <div class="col-lg-2">
      <h3>Sponsors</h3>
