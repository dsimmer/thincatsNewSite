...
(function ($) {
    ...
    $.alerts = {
        ...
        confirmOkButton: '&nbsp;Confirm&nbsp;', // text for the confirmation OK button
        ...
        _show: function (title, msg, value, type, callback, check) {
            ...
            switch (type) {
                case 'alert':
                    ...
                    break;
                case 'confirm':
                    $("#popup_message").after('<div id="popup_panel"><input type="button" value="' + $.alerts.confirmOkButton + '" id="popup_ok" /> <input type="button" value="' + $.alerts.cancelButton + '" id="popup_cancel" /></div>');
                    $("#popup_ok").click(function () {
                        $.alerts._hide();
